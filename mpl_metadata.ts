...
async function main(){
    ...
    const myKeypair = loadWalletKey("keypair1.json");
    const mint = new web3.PublicKey("GLSQTCkySdZdtxFE9DuwKJRPLBTbDAkbcKdK36Rkx42H");
    ...
    const ourMetadata = {
        "name": "Test F 20234",
        "symbol": "T234",  
        "uri": "https://wqub.vercel.app/metadata.json"
      }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
